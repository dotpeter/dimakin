...
function disable_default_dashboard_widgets() {
	...
	https://github.com/eddiemachado/dimakin/issues
	*/
}
/*
...
function dimack_rss_dashboard_widget() {
	...
	<h4 style="margin-bottom: 0;">
		<a href="<?php echo $item->get_permalink(); ?>" title="<?php echo mysql2date( __( 'j F Y @ g:i a', 'dimakin' ), $item->get_date( 'Y-m-d H:i:s' ) ); ?>" target="_blank">
