...
/* harmony import */ var _jquery_fancybox_min__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./jquery.fancybox.min */ "./assets/js/jquery.fancybox.min.js");
...
/* harmony import */ var _jquery_flexslider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./jquery.flexslider */ "./assets/js/jquery.flexslider.js");
/* harmony import */ var _jquery_flexslider__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_jquery_flexslider__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _custom_cookie_bar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./custom/cookie-bar */ "./assets/js/custom/cookie-bar.js");
/* harmony import */ var _custom_cookie_bar__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_custom_cookie_bar__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _custom_yoast_cmb2_data_analysis__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./custom/yoast-cmb2-data-analysis */ "./assets/js/custom/yoast-cmb2-data-analysis.js");
/* harmony import */ var _custom_yoast_cmb2_data_analysis__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_custom_yoast_cmb2_data_analysis__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _custom_onload__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./custom/onload */ "./assets/js/custom/onload.js");
/* harmony import */ var _custom_onload__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_custom_onload__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _custom_onready__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./custom/onready */ "./assets/js/custom/onready.js");
/* harmony import */ var _custom_onready__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_custom_onready__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _custom_swiper__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./custom/swiper */ "./assets/js/custom/swiper.js");
/* harmony import */ var _custom_swiper__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_custom_swiper__WEBPACK_IMPORTED_MODULE_7__);
...
/***/ "./assets/js/custom/cookie-bar.js":
/*!****************************************!*\
  !*** ./assets/js/custom/cookie-bar.js ***!
  \****************************************/
/***/ (() => {
...
(function ($) {
  $(window).load(function () {
    ...
    $("a[href$='.jpg'], a[href$='.png'], a[href$='.jpeg'], a[href$='.gif']").fancybox(); // Initialize the Lightbox and add rel="gallery" to all gallery images when the gallery is set up using [gallery link="file"] so that a Lightbox Gallery exists

    $(".gallery a[href$='.jpg'], .gallery a[href$='.png'], .gallery a[href$='.jpeg'], .gallery a[href$='.gif']").attr('data-fancybox', 'group').fancybox(); // Initalize the Lightbox for any links with the 'video' class and provide improved video embed support
  ...
  $('#btn-return-to-top').click(function () {
  ...
  $(document).ready(function () {
    ...
    $('#mobile-toggle-open').click(function () {
      if (isMenuOpen == false) {
        ...
        $('#mobile-grey-back').fadeIn('fast'); //$(this).fadeOut(200);
        //$('.close').fadeIn(300);
    ...
    $('#mobile-grey-back, #mobile-toggle-close').click(function () {
      if (isMenuOpen == true) {
        ...
        $('#mobile-grey-back').fadeOut('fast'); //$(this).fadeOut(200);
...
/***/ "./assets/js/custom/yoast-cmb2-data-analysis.js":
/*!******************************************************!*\
  !*** ./assets/js/custom/yoast-cmb2-data-analysis.js ***!
  \******************************************************/
/***/ (() => {
...
(function ($) {
  ...
  var MyCustomDataPlugin = /*#__PURE__*/function () {
    function MyCustomDataPlugin() {
      _classCallCheck(this, MyCustomDataPlugin); // Ensure YoastSEO.js is present and can access the necessary features.
    ...
    _createClass(MyCustomDataPlugin, [{
      ...
      value: function addContent(data) {
        var cmb2_content = '';
        $('#wp-_dimakin_products_fulltext-wrap').find('textarea').each(function () {
          if ($(this).val()) {
            cmb2_content += '';
  ...
  if (typeof YoastSEO !== "undefined" && typeof YoastSEO.app !== "undefined") {
    new MyCustomDataPlugin(); //console.log('ya detectou o yoast');
  } else {
    jQuery(window).on("YoastSEO:ready", function () {
      new MyCustomDataPlugin(); //console.log('o yoast ficou ready e activei');
    });
  }
})(jQuery);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkdimakin"] = self["webpackChunkdimakin"] || [];
