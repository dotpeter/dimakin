...
if ( $products_loop->have_posts() ) :
  echo '<section class="products-wrapper"><div class="container"><div class="row"><div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><a href="' , get_post_type_archive_link( 'product' ) , '"><h2 class="section-title">' ,  esc_html__( 'Produtos', 'dimakin' ) , '</h2></a></div></div><div class="row"><div class="col-12"><div class="products-slider-wrapper"><div class="products-slider-container">';
